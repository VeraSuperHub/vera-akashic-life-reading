...
| `astrology-calculator` | Full astrology-based reading after ephemeris output is confirmed. |
...
```json
{
  ...
  "interpretation_mode": "reflective or akashic-simple"
}
```
  ...
  "bazi": {
    ...
    "structure": {
      ...
      "branch_interactions": [
        {
          "type": "three-meeting",
          "name": "Hai-Zi-Chou water meeting",
...
- For luck cycles and annual themes, sex/gender is required only because the traditional forward/reverse rule uses it; do not overstate gender identity beyond this calculation convention.
...
- For Western astrology, record zodiac, house system, birth timezone, coordinates, ephemeris source, essential dignity scheme, house-ruler scheme, and Part of Fortune formula. Flag planets or angles near sign cusps, and planets near house cusps, because categorical sign/house labels may change under small time/location/house-system corrections.
- For traditional Western astrology, record tradition, zodiac, whole-sign house model, traditional ruler scheme, sect, lots, annual profection target dates, and omitted techniques. Treat profections and time lords as symbolic timing context, not event prediction.
- For Vedic/Jyotish astrology, record ayanamsa, node choice, lagna/house model, dasha system, and ephemeris source. Treat dasha as symbolic timing context, not deterministic prediction.
