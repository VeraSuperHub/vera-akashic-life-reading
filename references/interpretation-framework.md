...
Use this framework only after chart facts are verified or explicitly marked partial. The central skill is not stacking systems; it is letting one verified system correct, qualify, or sharpen another.

## Element Vocabulary Boundary
...
Treat correction as the first synthesis move.
...
Do not force agreement. If systems conflict and no correction pattern is clear, say the systems are giving different lenses and keep the interpretation modular.

## Boundary-Sensitive Facts
...
When a boundary warning exists, phrase the summary as "calculated as..." rather than "is..." until the user confirms the setting.

## Interpretation Modes

### Reflective

Default for cautious users, partial data, or first contact.

- Use grounded language: "suggests", "points to", "can be read as", "a useful practice is".
- Keep the reading clear, bounded, and practical.
- Prefer interpretation over dramatic scene-setting.
...
- It is acceptable to say "your soul is practicing..." as symbolic language after the disclaimer.
- Build concrete archetypal scenes, but never claim they are guaranteed factual memories.
- Include body-response prompts so the user can notice which passages resonate somatically.

## Output Shapes

### Analysis-Centered

Useful for calculation review or cautious interpretation.
...
Preferred for `akashic-full` mode.

1. Soul Identity: all systems integrated into a single inner image.
2. Past-Life Archetypes: symbolic scenes, each tagged with the chart mechanics that support it.
3. This-Life Contracts: the growth tasks the systems converge on.
4. Recurring Patterns: each pattern names its multi-system causation.
5. Gifts and Talents: perception, creation, teaching, healing, leadership, or strategy channels.
6. Relationships: attachment style, trust practice, relational gifts, and non-fatalistic cautions.
7. Career and Mission: visibility, service, systems, timing context, and practical form.
8. Practices: grounded rituals, behavior experiments, and body-based integration.
...
- Write as reflective guidance, not deterministic prophecy.
- Avoid fear-based claims, irreversible destiny language, or certainty about events.
- Prefer practical integration over mystical spectacle.
- In `akashic-full` mode, intensity is allowed; certainty about real-world outcomes is not.
