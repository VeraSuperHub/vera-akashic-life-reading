# Worked Example: Synthetic Cross-System Correction

This example is synthetic. Do not reuse names, exact birth data, locations, or story details from real users.

## Input

- Display name: Synthetic Case A
- Birth data: synthetic complete birth data supplied to calculators
- BaZi summary: day master is wood; chart has strong water and wood signatures; fire is not visible in the four pillars
- Western summary: Sun is in a fire sign with strong dignity and a creative house emphasis; several traditional house rulers land in the same creative house
- Optional numerology: Life Path points to inner inquiry; Birthday Number points to public building
...
Read the corrected thesis slowly. If the body reacts more to "not absent" than to "needs more," the correction is doing its job. If the body reacts more to "audience" than to "expression," refine the reading toward distribution and reach.
